...
describe('Kaltura Service', () => {
			...
			const data = [
				{
					partnerId: 1500101,
					ks:
						'djJ8MTUwMDEwMXwvhxzhuHGGz5EjPAOn2oj-zzUW1JlHoDrdrZw0pmWKu4iZQ_ZBxMCRjQCPSls887JHBgSbl5dxdnj41jW5cpGPZNwakps1n30iZ7Pz_Q5LNQ==',
					userId: 0,
				...
				},
				{
					...
					sourceType: '1',
					dataUrl:
						'https://cdnapisec.kaltura.com/p/1500101/sp/150010100/playManifest/entryId/0_nmii7y4j/format/url/protocol/https',
					flavorParamsIds:
						'0,487041,487051,487061,487071,487081,487091,487111,702572,704451,704461',
					plays: 4597,
					views: 171544,
					...
					votes: 0,
					downloadUrl:
						'https://cdnapisec.kaltura.com/p/1500101/sp/150010100/playManifest/entryId/0_nmii7y4j/format/download/protocol/https/flavorParamIds/0',
					searchText:
						'_PAR_ONLY_ _1500101_ _MEDIA_TYPE_1|  Janux Promo Video janux Janux, a new interactive learning community created in partnership between The University of Oklahoma and technology leader NextThought, connects learners and teachers through high-quality OU courses. Janux is the first of its kind in OpenCourseWare, combining multimedia-rich content with interactive social tools and a broader learning community to create an unparalleled learning environment.Copyright u00a9 2000-2014 The Board of Regents of the University of Oklahoma, All Rights Reserved. ',
					licenseType: -1,
					version: 0,
					thumbnailUrl:
						'https://cfvod.kaltura.com/p/1500101/sp/150010100/thumbnail/entry_id/0_nmii7y4j/version/100022',
	...
	test('should have default tracks', async () => {
		const { container } = render(
			<Kaltura source={'kaltura://1500101/0_nmii7y4j/'} />
		);
		await waitFor(() => {
			const track = container.querySelector('track');
			const trackSrc =
				'https://cdnapisec.kaltura.com/api_v3/index.php/service/caption_captionasset/action/serveWebVTT/segmentDuration/155/segmentIndex/1/captionAssetId/0_qazodgom/ks/djJ8MTUwMDEwMXwvhxzhuHGGz5EjPAOn2oj-zzUW1JlHoDrdrZw0pmWKu4iZQ_ZBxMCRjQCPSls887JHBgSbl5dxdnj41jW5cpGPZNwakps1n30iZ7Pz_Q5LNQ==';
	...
	test('should have custom tracks', async () => {
		const transcript = {
			...
			Links: [
				{
					Class: 'Link',
					href:
						'/dataserver2/NTIIDs/tag%3Anextthought.com%2C2011-10%3ANTI-NTITranscript-system_20180109193631_867872_3762585815.0',
					method: 'PUT',
					ntiid:
						'tag:nextthought.com,2011-10:NTI-NTITranscript-system_20180109193631_867872_3762585815.0',
					rel: 'edit',
				},
			],
			...
			NTIID:
				'tag:nextthought.com,2011-10:NTI-NTITranscript-system_20180109193631_867872_3762585815.0',
			OID:
				'tag:nextthought.com,2011-10:josh.birdwell@nextthought.com-OID-0x04d807:5573657273:y2DnJDy2AAY',
			lang: 'en',
			purpose: 'normal',
			src:
				'/dataserver2/Objects/tag%3Anextthought.com%2C2011-10%3Asystem-OID-0x04d808%3A5573657273/@@download/test.vtt',
			srcjsonp: null,
			type: 'text/vtt',
		};
		const { container } = render(
			<Kaltura
				source={'kaltura://1500101/0_nmii7y4j/'}
				tracks={[transcript]}
			/>
		);
